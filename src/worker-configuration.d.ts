/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 19484bbf3428d5eefecf83c0a34e22c2)
// Runtime types generated with workerd@1.20260120.0 2026-01-16 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		BETTER_AUTH_TRUSTETD_ORIGIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_TRUSTETD_ORIGIN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_D1_NAME">> {}
}
